        ...
        <div className="bg-gray-50">
            <div className="bg-white xl:hidden flex text-gray-800  hover:text-black focus:outline-none focus:text-black justify-between w-full p-6 items-center ">
                ...
                <div aria-label="toggler" className="flex justify-center items-center">
                    <button id="open" onClick={() => setIsActive(!active)} aria-label="open" className={`${active ? "" : "hidden"} focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-gray-800`}>
                    ...
                    <button id="close" onClick={() => setIsActive(!active)} aria-label="close" className={`${active ? "hidden" : ""} focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-gray-800`}>
                        <svg className="text-gray-800" width={24} height={24} viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
            ...
            <div id="Main" className={`${active ? "-translate-x-full" : "translate-x-0"} bg-white transform  xl:translate-x-0 ease-in-out transition duration-500 flex justify-start items-start w-full sm:w-72   flex-col h-full`}>
                ...
                <div className="flex mt-5 bg-indigo-700 justify-start space-x-2 items-center h-full py-4 px-3.5 w-full">
                    <div>
