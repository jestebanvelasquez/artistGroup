...
import { deshabilitarEvento, getAllEvents } from "../../../../redux/actions/Events";
...
export default function AllEvents({ changeView }: ChangeViewProps) {
    ...
    return (
        <>
            <div className="w-full h-full p-4 overflow-auto">
                <p className="text-4xl text-center font-bold mb-5">Todos los eventos</p>
